      ...
      <div className="max-w-screen-xl mx-auto py-10 sm:py-14 lg:py-16 2xl:py-20  flex flex-col sm:flex-row gap-5">
        ...
        <article className="sm:w-2/3">
          <p className="text-sm sm:text-base lg:text-lg 2xl:text-xl text-justify noto-serif-bengali-font">
            ...
            ধরনের পরামর্শ পেয়ে থাকবেন। যদি আপনি কোন ধরনের দেওয়ানি, ফৌজদারি,
            কোম্পানি রেজিষ্ট্রেশন করা, আয়কর বিষয় বা যে কোন ধরনের আইনি সমস্যায়
            পড়ে থাকেন বা সমস্যা থেকে প্রতিকার পেতে পরামর্শ নিতে চান সেক্ষেত্রে
            আপনাকে সহযোগিতা করতে সর্বদা প্রস্তুত আছে আমাদের "লিগ্যাল ম্যাটার
            বিডি" এর বিজ্ঞ আইনজীবীদের সমন্বয় টিম।
            ...
            <br /> আমাদের এখান থেকে চাইলেই আপনি পাচ্ছেন, ভূমি সার্ভে করা,
            ইমিগ্রেশন বিষয়ে পরামর্শ, অভিজ্ঞ আর্কিটেক্ট ইঞ্জিনিয়ারের পরামর্শ সহ
            অনলাইন এর ভূমি সেবা, ই পাসপোর্টের আবেদন করা, ড্রাইভিং লাইসেন্স এর
            আবেদন করা সহ ডিজিটাল সকল সুযোগ সুবিধা।
          </p>
        </article>
      </div>
    </section>
